...
public:
	...
	void receiveTrackingData(cv::Scalar direction, int id, long int time)
	{
		...
		std::cout << "Direction: " << direction.val[0] << ", " << direction.val[1] << ", " << direction.val[2] <<
		std::endl;
	}
};
...
int main(int argc, char **argv)
{
	...
	processor.addQuadcopter(new QuadcopterColor(40, 78, 120, 255, 100, 255, 0));
	processor.addQuadcopter(new QuadcopterColor(163, 177, 120, 255, 100, 255, 1));
