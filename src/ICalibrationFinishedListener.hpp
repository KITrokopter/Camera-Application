...
/**
 * Listener, that is informed when the camera calibration is finished.
 *
...
public:
	/**
	 * Is called after the calibration of one camera is finished. The callee has
	 * to free the given matrices.
	 *
