...
public:
	/**
	 * Creates a new object. The visualTracker option is disabled using this
	 *constructor.
	 *
	 ...
	 * @param dataReceiver An object to send the calculated quadcopter positions
	 *to.
	 * @param visualTracker If true, an OpenCV window will show the results of
	 *the tracking process live.
	 * @param useMaskedImage If the color masked image or the original image
	 *should be shown.
	 *                       Only has an effect if useMaskedImage is set to
	 *true.
	 */
	...
	/**
	 * Waits for the calibration to finish. Only works, if the {@link
	 *startCalibration} method was used.
	 */
	 ...
	 * been set via the {@link setIntrinsicsMatrix} and {@link
	 *setDistortionCoefficients} methods.
	 * The caller has to delete the result.
	 *
