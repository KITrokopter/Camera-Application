...
public:
	 ...
	 * 
	 * @param direction The 3D-vector pointing into the direction of the quadcopter, as seen from the camera.
	 *                  The (0, 0, 1) vector is the middle of the image, negative x is left, negative y down.
	 * @param id The id of the quadcopter this vector belongs to.
	 * @param time The time the image that was used to calculate this vector was taken.
	 */
